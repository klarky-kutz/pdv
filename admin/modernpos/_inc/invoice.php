...
// DB table to use
$table = "(SELECT selling_info.*, selling_price.payable_amount, selling_price.paid_amount FROM `selling_info` LEFT JOIN `selling_price` ON (selling_info.invoice_id = selling_price.invoice_id) WHERE $where_query) as selling_info";
