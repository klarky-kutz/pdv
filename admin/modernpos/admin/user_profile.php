...
// Permissões:
// - Admin (group_id=1) pode acessar perfis.
// - Usuário sem permissão read_user_profile ainda pode acessar o PRÓPRIO perfil.
$requestedProfileId = isset($request->get['id']) ? (int)$request->get['id'] : 0;
...
if (
  ...
  && (int)$requestedProfileId !== (int)user_id()
) {
  redirect(root_url().ADMINDIRNAME.'/dashboard.php');
}
...
// FETCH USER INFO
$this_user = $this_user_model->getUser($requestedProfileId);
...
// Removido: histórico de login no perfil (admin) - será exibido via painel /conta
      ...
      <div class="col-xs-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            <?php /* Aba removida (sem apagar): histórico de login foi movido para /conta/usuarios */ ?>
            <li class="pull-right">
          ...
          <div class="tab-content">
            ...
            <?php /* Histórico de login removido do perfil (admin) - movido para /conta/usuarios */ ?>
