...
<head>
	...
	<!-- This is Mandatory -->
	<?php
		$pos_pattern = $user->getPreference('pos_pattern') ? $user->getPreference('pos_pattern') : '1islamic.jpg';
		$pattern_file = dirname(__DIR__) . '/assets/itsolution24/img/pos/patterns/' . $pos_pattern;
		if (!is_file($pattern_file)) {
			$pos_pattern = '1islamic.jpg';
		}
	?>
	<style>
		body::after { 
			content: ""; background: url(../assets/itsolution24/img/pos/patterns/<?php echo $pos_pattern; ?>) repeat repeat;opacity: 0.4;filter: alpha(opacity=40);top: 0;left: 0;bottom: 0;right: 0;position: absolute;z-index: -1;
		}
	...
	<script type="text/javascript">
        ...
        var store = <?php 
          $storeData = array_diff_key(store(), array_flip(array('smtp_password','ftp_password','preference')));
          $storeData['walkin_customer_id'] = (int)get_preference('walkin_customer_id');
							...
							<div class="well well-sm">
								...
								<div id="pay-button" class="text-center">
									<div class="btn-group btn-group-justified">
										...
										<div class="btn-group">
											<button ng-click="HoldingOrderModal()" onClick="return false;" class="btn btn-danger" data-loading-text="Processing..." title="Reservar Pedido">
												<span class="fa fa-fw fa-pause-circle"></span> 
...
<!-- Customer Quick Modal CSS -->
<link href="../assets/itsolution24/css/customer-quick-modal.css" type="text/css" rel="stylesheet">
...
<script src="../assets/itsolution24/angular/modals/CustomerQuickCreateModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/CustomerEditModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/CustomerCreateModal.js" type="text/javascript"></script>
...
<script src="../assets/itsolution24/angular/modals/ProductQuickCreateModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/ProductCreateModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/ProductViewModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/ProductEditModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/GiftcardCreateModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/GiftcardViewModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/PaymentFormModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/InvoiceViewModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/PrintReceiptModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/CategoryCreateModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/SupplierCreateModal.js" type="text/javascript"></script>
<script src="../assets/itsolution24/angular/modals/BoxCreateModal.js" type="text/javascript"></script>
