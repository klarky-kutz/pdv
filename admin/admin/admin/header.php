...
$demo_text = 'This is a demo version. <a href="https://codecanyon.net/cart/configure_before_adding/22702683" target="_blank" class="demo-buy-btn" >Buy from Codecanyon &rarr;</a>';
?>
<!DOCTYPE html>
<html lang="<?php echo $document->langTag($active_lang);?>" <?php echo !isset($angular_disabled) ? 'ng-app="angularApp"' : null; ?>>
  <head>
    ...
    <!-- SaaS Multi-Tenant: Ocultar Store Changer se permissão negada -->
    <?php 
    $can_switch = has_permission('access', 'switch_store');
    if (!$can_switch): 
    ?>
    <style>
        /* Ocultar elementos do Store Changer quando permissão negada */
        .store-changer,
        .store-selector,
        .change-store-btn,
        [href*="store_select.php"],
        [ng-click*="changeStore"],
        [ng-click*="selectStore"] {
    ...
    <script type="text/javascript">
        ...
        // SaaS Multi-Tenant: Controle de permissão para trocar de loja
        var canSwitchStore = <?php echo $can_switch ? 'true' : 'false'; ?>;
    </script>

    <?php if (DEMO || USECOMPILEDASSET) : ?>

        <script src="../assets/itsolution24/jsmin/main.js" type="text/javascript"></script>
        <!-- Calculator Modal JS (custom addition) -->
        <script src="../assets/itsolution24/angular/modals/CalculatorModal.js" type="text/javascript"></script>
...
<div class="hidden"><?php include(ROOT . '/assets/itsolution24/img/iconmin/icon.svg'); ?></div>
<div class="wrapper">
<?php include ROOT . '/_inc/template/partials/top.php'; ?>
<?php 
// Incluir Modal de Upgrade IA (FASE T5)
if (file_exists(__DIR__ . '/_modals/modal_ai_upgrade.php')) {
    include __DIR__ . '/_modals/modal_ai_upgrade.php';
}
?>
