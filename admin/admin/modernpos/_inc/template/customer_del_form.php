<h4 class="sub-title">
  <i class="fa fa-trash text-danger"></i> Excluir Cliente
</h4>
<form class="form" id="customer-del-form" action="customer.php" method="post">
  ...
  <h4 class="box-title text-center">
    Transferir dados para outro cliente antes de excluir
  </h4>
  <div class="box-body">
    <div class="row">
      <div class="col-sm-6 col-sm-offset-3">
        <label for="insert_to" class="control-label">
          <i class="fa fa-exchange text-info"></i> Transferir histórico para:
        </label>
        <div class="radio">
