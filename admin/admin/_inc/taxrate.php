...
$columns = array(
  ...
  array(
    ...
    'dt'        => 'btn_edit',
    'formatter' => function( $d, $row ) {
      // Bloqueia edição de taxas globais/padrão
      ...
      $taxrate_name = isset($row['taxrate_name']) ? $row['taxrate_name'] : '';
      $code_name = isset($row['code_name']) ? $row['code_name'] : '';
      if (is_global_item($taxrate_name, 'taxrate') || is_global_item($code_name, 'taxrate')) {
  ...
  array(
    ...
    'dt'        => 'btn_delete',
    'formatter' => function( $d, $row ) {
      // Bloqueia exclusão de taxas globais/padrão
      if ($row['taxrate_id'] == 1) {
