...
function (
    ...
    $("#invoice-invoice-list").dataTable({
        ...
        "columnDefs": [
            {"targets": [1, 6, 7, 8, 9, 10], "orderable": false},
    ...
    $("#email-btn").on( "click", function (e) {
        e.stopPropagation();
        e.preventDefault();
        dt.find("thead th:nth-child(7), thead th:nth-child(8), thead th:nth-child(9), thead th:nth-child(10), thead th:nth-child(11), tbody td:nth-child(7), tbody td:nth-child(8), tbody td:nth-child(9), tbody td:nth-child(10), tbody td:nth-child(11), tfoot th:nth-child(7), tfoot th:nth-child(8), tfoot th:nth-child(9), tfoot th:nth-child(10), tfoot th:nth-child(11)").addClass("hide-in-mail");
        var thehtml = dt.html();
