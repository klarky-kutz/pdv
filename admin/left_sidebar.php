    ...
    <ul class="sidebar-menu">
      ...
      <?php if (user_group_id() == 1 || has_permission('access', 'read_user') || has_permission('access', 'read_usergroup') || has_permission('access', 'change_password')) : ?>
        <li class="treeview<?php echo current_nav() == 'user' || current_nav() == 'user_group' || current_nav() == 'password' ? ' active' : null; ?>">
          ...
          <ul class="treeview-menu">
            <?php /* Removidos no painel /admin: Add User, Add User Group, UserGroup List (usar /conta) */ ?>
        ...
        <li class="treeview<?php echo current_nav() == 'store' || current_nav() == 'receipt_template' || current_nav() == 'store_create' || current_nav() == 'user_preference' || current_nav() == 'store_single' || current_nav() == 'brand' || current_nav() == 'currency' || current_nav() == 'pmethod' || current_nav() == 'unit' || current_nav() == 'taxrate' || current_nav() == 'box' || current_nav() == 'printer' || current_nav() == 'sms_setting' || current_nav() == 'language' ? ' active' : null; ?>">
          ...
          <ul class="treeview-menu">
            ...
            <?php if (user_group_id() == 1 || has_permission('access', 'receipt_template')) : ?>
              <li class="<?php echo current_nav() == 'receipt_template' || current_nav() == 'select_receipt_template' ? 'active' : null; ?>">
                <a href="select_receipt_template.php">
                  <svg class="svg-icon"><use href="#icon-report"></svg>
                  <span>
            ...
            <?php 
            // Verificação redundante para Language - apenas Admin SaaS (user_group_id == 1)
            $is_admin_saas = (user_group_id() == 1);
            $is_admin_saas_check = (isset($user) && $user->getGroupId() == 1);
            $is_admin_saas_final = ($is_admin_saas && $is_admin_saas_check);
            
            if ($is_admin_saas_final && has_permission('access', 'read_language')) : 
            ?>
      ...
      <?php if ((user_group_id() == 1 || has_permission('access', 'activate_store')) && has_permission('access', 'switch_store')) : ?>
      ...
      <?php endif; ?>
      <!-- ── Moda IA PRO ── -->
      <li class="treeview<?php echo (strpos(current_nav(),'concierge_')===0)?' active':null;?>" style="border-top:2px solid #2d1b5e;background:linear-gradient(180deg,#160a2e,#1a0f35)">
        <a href="concierge_catalogo.php" style="color:#9f6ae3;border-left:3px solid #7c4aed;">
          <i class="fa fa-magic" style="color:#a78bfa;width:20px;text-align:center;font-size:13px;"></i>
          <span style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#7c4aed;margin-left:4px;">
            Moda IA
            <span style="background:linear-gradient(135deg,#f59e0b,#d97706);color:#fff;font-size:9px;font-weight:700;padding:2px 6px;border-radius:20px;margin-left:4px;vertical-align:middle">PRO</span>
          </span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right" style="color:#7c4aed"></i>
          </span>
        </a>
        <ul class="treeview-menu" style="background:#130d28;">
          <li class="<?php echo current_nav()=='concierge_catalogo'?'active':null;?>">
            <a href="concierge_catalogo.php" style="color:#9f6ae3;padding:8px 12px 8px 20px;">
              <i class="fa fa-tag" style="color:#a78bfa;width:16px;text-align:center;font-size:12px;margin-right:6px;"></i>
              <span>Cat&aacute;logo IA</span>
            </a>
          </li>
          <li class="<?php echo current_nav()=='concierge_pedidos'?'active':null;?>">
            <a href="concierge_pedidos.php" style="color:#9f6ae3;padding:8px 12px 8px 20px;">
              <i class="fa fa-trello" style="color:#a78bfa;width:16px;text-align:center;font-size:12px;margin-right:6px;"></i>
              <span>Pedidos</span>
              <span id="mia-orders-badge" style="display:none;margin-left:8px;background:#dc2626;color:#fff;font-size:10px;font-weight:800;padding:1px 6px;border-radius:20px;vertical-align:middle"></span>
            </a>
          </li>
          <li class="<?php echo current_nav()=='concierge_conversas'?'active':null;?>">
            <a href="concierge_conversas.php" style="color:#9f6ae3;padding:8px 12px 8px 20px;">
              <i class="fa fa-comments" style="color:#a78bfa;width:16px;text-align:center;font-size:12px;margin-right:6px;"></i>
              <span>Conversas</span>
            </a>
          </li>
          <li class="<?php echo current_nav()=='concierge_pix'?'active':null;?>">
            <a href="concierge_pix.php" style="color:#9f6ae3;padding:8px 12px 8px 20px;">
              <i class="fa fa-qrcode" style="color:#a78bfa;width:16px;text-align:center;font-size:12px;margin-right:6px;"></i>
              <span>Comprovantes Pix</span>
            </a>
          </li>
          <li class="<?php echo current_nav()=='concierge_estoque'?'active':null;?>">
            <a href="concierge_estoque.php" style="color:#9f6ae3;padding:8px 12px 8px 20px;">
              <i class="fa fa-cubes" style="color:#a78bfa;width:16px;text-align:center;font-size:12px;margin-right:6px;"></i>
              <span>Estoque IA</span>
            </a>
          </li>
          ...
          <li class="<?php echo current_nav()=='concierge_config'?'active':null;?>">
            <a href="concierge_config.php" style="color:#9f6ae3;padding:8px 12px 8px 20px;">
              <i class="fa fa-cog" style="color:#a78bfa;width:16px;text-align:center;font-size:12px;margin-right:6px;"></i>
              <span>Configura&ccedil;&otilde;es IA</span>
            </a>
          </li>
          <li class="<?php echo current_nav()=='concierge_tokens'?'active':null;?>">
            <a href="concierge_tokens.php" style="color:#9f6ae3;padding:8px 12px 8px 20px;">
              <i class="fa fa-database" style="color:#a78bfa;width:16px;text-align:center;font-size:12px;margin-right:6px;"></i>
              <span>Cr&eacute;ditos IA</span>
            </a>
          </li>
        </ul>
      </li>
