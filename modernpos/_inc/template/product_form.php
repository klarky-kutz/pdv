              ...
              <div class="well well-sm store-well">
                <div filter-list="search_store">
                  ...
                  <?php foreach($store_list as $the_store) : ?>                    
                    ...
                    <div class="checkbox">
                      <label>      
                        <input type="checkbox" name="product_store[]" value="<?php echo (int)$the_store['store_id']; ?>" <?php echo (isset($product['stores']) && in_array((int)$the_store['store_id'], array_map('intval', $product['stores']), true)) ? 'checked' : null; ?>>
