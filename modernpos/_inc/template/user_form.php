...
<form class="form-horizontal" id="user-form" action="user.php" method="post">
  ...
  <div class="box-body">
    ...
    <!-- Grupo: removido do modal para evitar exposição/alteração indevida de grupos no /admin -->
    <input type="hidden" name="group_id" value="<?php echo (int)$the_user['group_id']; ?>">
