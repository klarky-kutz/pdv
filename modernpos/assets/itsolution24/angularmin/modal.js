            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                .then(function(response, status, headers, config) {
                    ...
                    setTimeout(function() {
                        ...
                        // Auto gera código sequencial (prefixo 7898) ao abrir o modal
                        function setNextPcode(mode) {
                            var m = mode || 'seq';
                            $http({
                            ...
                            .then(function(resp) {
                                if (resp && resp.data && resp.data.p_code) {
                                    $(document).find('#p_code').val(resp.data.p_code);
                                }
                            });
                        }
                        ...
                        // Clique para gerar aleatório (mantém prefixo 7898 e não repete códigos existentes)
                        $(".random_num").off('click').on('click', function(){
                            setNextPcode('random');
                        });
                   ...
                   window.swal("Oops!", (response && response.data && response.data.errorMsg) ? response.data.errorMsg : 'Ocorreu um erro. Tente novamente.', "error");
                });
